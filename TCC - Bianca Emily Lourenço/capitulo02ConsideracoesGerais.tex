...
\begin{figure}[!htbp]
	...
	\\\textbf{Fonte:} \cite{ImagemFutebol}
	\label{fig:futebol}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	...
	\\\textbf{Fonte:} \cite{ImagemEuroTruck}
	\label{fig:simulacao}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	...
	\\\textbf{Fonte:} \cite{ImagemWitcher3}
	\label{fig:rpg}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	...
	\\\textbf{Fonte:} \cite{ImagemAnimalCrossing}
	\label{fig:cozy}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	...
	\\\textbf{Fonte:} \cite{ImagemGodotInterface}
	\label{fig:godot}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	...
	\\\textbf{Fonte:}\cite{ImagemUnityInterface}
	\label{fig:unity}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	...
	\\\textbf{Fonte:}\cite{ImagemUnrealInterface}
	\label{fig:unreal}
\end{figure}
\FloatBarrier
...
\begin{figure}[!htbp]
	...
	\\\textbf{Fonte:} \cite{ImagemGameMakerInterface}
	\label{fig:gamemaker}
\end{figure}
\FloatBarrier
